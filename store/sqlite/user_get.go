...
func (s *SqliteAccountStore) GetUser(id int64) (*store.User, error) {
	var user store.User
...
func (s *SqliteAccountStore) GetUserByName(name string) (*store.User, error) {
	var user store.User
...
func (s *SqliteAccountStore) GetUserByEmail(email string) (*store.User, error) {
	var user store.User
